    ...
    <div className="max-w-screen-xl mt-24 px-8 xl:px-16 mx-auto">
      <div className="grid grid-flow-row sm:grid-flow-col grid-rows-2 md:grid-rows-1 sm:grid-cols-2 gap-8 py-6 sm:py-16">
        <div className="flex flex-col justify-center items-start row-start-2 sm:row-start-1">
          ...
          <button className="py-3 lg:py-4 px-12 lg:px-16 text-white-500 font-semibold rounded-lg bg-primary transition-all outline-none ">
            Get Started
          </button>
        </div>
          ...
          {listUser.map((listUsers, index) => (
            ...
            >
              <div className="flex mx-auto w-40 sm:w-auto">
                <div className="flex items-center justify-center bg-secondary w-12 h-12 mr-6 rounded-full">
                  <FaUser className="h-6 w-6 fill-primary" />
                </div>
